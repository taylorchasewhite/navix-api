...
namespace Navix.FreightAudit.Models.Invoice.Models.Integrations
{
    ...
    public partial class InvoiceAuditResultVendorChargeV2 : IParsable
...
#nullable restore
        ...
        public string Code { get; set; }
#endif
        /// <summary>The description that accompanies the `Code`. Codes and descriptions are both provided by the tenant.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string Type { get; set; }
#endif
        /// <summary>The unique identifier for the charge type. This may or may not have meaning to the API consumer&apos;s system.</summary>
        public Guid? TypeUuid { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultVendorChargeV2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultVendorChargeV2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultVendorChargeV2();
        }
        /// <summary>
