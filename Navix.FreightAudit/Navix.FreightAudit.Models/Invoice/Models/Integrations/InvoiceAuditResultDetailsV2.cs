...
namespace Navix.FreightAudit.Models.Invoice.Models.Integrations
{
    ...
    public partial class InvoiceAuditResultDetailsV2 : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The date (without time) the invoice was finalized (either approved or terminated). Note that terminated invoices still have a value here.</summary>
...
#nullable restore
        ...
        /// <summary>The date (without time) the invoice was ingested by Navix</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultInvoiceReferenceNumberV2>? InvoiceReferenceNumbers { get; set; }
#nullable restore
#else
        public List<global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultInvoiceReferenceNumberV2> InvoiceReferenceNumbers { get; set; }
#endif
        /// <summary>Line items for the original invoice.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultLineItemDetailV2>? LineItems { get; set; }
#nullable restore
#else
        public List<global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultLineItemDetailV2> LineItems { get; set; }
#endif
        /// <summary>An identifier for the invoice, often the unique identifier in the tenant&apos;s TMS.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>The source of the document. Possible values include:* `Manual`: the document was uploaded through the Navix UI* `EDI`: the document was received thrugh EDI* `Email`: the document was received via email* `API`: the document was uploaded to the Navix APISome deprecated endpoints refer to this as `VendorInvoiceFormatDescription`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultStopV2>? Stops { get; set; }
#nullable restore
#else
        public List<global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultStopV2> Stops { get; set; }
#endif
        /// <summary>This is used to annotate any additional information about the invoice that the system can use to process.          &lt;example&gt;&quot;tags&quot;: {{&quot;No Order&quot;: null}}&lt;/example&gt;</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultDetailsV2_tags? Tags { get; set; }
#nullable restore
#else
        public global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultDetailsV2_tags Tags { get; set; }
#endif
...
#nullable restore
        ...
        public string TerminatedMessage { get; set; }
#endif
        /// <summary>If the invoice was terminated, the reason why it was terminated. This is null if the invoice was approved.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultVendorV2? Vendor { get; set; }
#nullable restore
#else
        public global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultVendorV2 Vendor { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultDetailsV2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultDetailsV2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Navix.FreightAudit.Models.Invoice.Models.Integrations.InvoiceAuditResultDetailsV2();
        }
        /// <summary>
